...
from dual;
select '20,000' - '10,000' --계산안됨
from dual;
select to_number('20,000','99,999,999') - to_number('10,000','99999')
from dual;
...
-- 평균 급여
select avg(sal), trunc(avg(sal),2)
from emp;
