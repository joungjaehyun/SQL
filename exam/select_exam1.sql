...
select ename, deptno from emp where deptno !=10 order by ename desc;
...
select ename, job from emp where mgr is null or mgr =0;
...
select ename, sal, comm from emp where comm is not null and comm >500;